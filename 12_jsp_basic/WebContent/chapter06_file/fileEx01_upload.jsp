...
<body>
	<% 
		...
		// 파일의 업로드 경로를 지정해 줄 때 웹 경로가 아닌 실제 경로를 작성해야 한다.
		String fileSaveLocation = "D:\\ABU\\12_web_share_folder\\workspace\\12_jsp_basic\\WebContent\\chapter06_file\\attachment_file";
